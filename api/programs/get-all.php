...
try {
    ...
    while ($row = $stmt->fetch()) {
        ...
        $program = [
            ...
            'units' => $row['units'],
            'image_path' => $row['image_path'] ? 'assets/img/programs/' . basename($row['image_path']) : null,
            'prospectus_path' => $row['prospectus_path'] ? 'assets/img/programs/prospectus/' . basename($row['prospectus_path']) : null,
