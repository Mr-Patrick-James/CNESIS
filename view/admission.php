...
<head>
  ...
  <style>
    ...
    * {
    ...
    /* Navigation Styles (will be loaded dynamically) */
    .navbar {
      ...
      <div class="row">
        ...
        <div class="col-lg-2 col-md-6 mb-4">
          ...
          <div class="footer-links">
            ...
            <a href="../views/user/about.html">About Us</a>
            <a href="../views/user/program.html">Academic Programs</a>
            <a href="admission.php">Admissions</a>
            <a href="handbook.pdf">Student Handbook</a>
          </div>
        </div>
