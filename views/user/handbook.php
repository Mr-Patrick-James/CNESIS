<?php
/**
 * Student Handbook Page – Colegio De Naujan
  ...
  <footer class="footer">
    <div class="container">
      ...
      <div class="footer-bottom text-center">
        <p class="mb-0">&copy; <span id="year"></span> <?php echo $settings['institution_name'] ?? 'Colegio De Naujan'; ?>. All Rights Reserved. | <a href="#" class="text-white">Privacy Policy</a> | <a href="#" class="text-white">Terms of Use</a></p>
      </div>
    </div>
  </footer>
