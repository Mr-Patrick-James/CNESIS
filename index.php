              ...
              <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end shadow border-0 mt-2" aria-labelledby="profileDropdown" style="border-radius: 12px; min-width: 200px;">
                  ...
                  <?php if (in_array($user_role, ['admin', 'staff'])): ?>
                    <li><a class="dropdown-item py-2" href="views/admin/features/dashboard.php"><i class="fas fa-tachometer-alt me-2 text-primary"></i> Admin Dashboard</a></li>
                  <?php else: ?>
  ...
  <footer class="footer">
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-3 col-md-6 mb-4">
          ...
          <div class="footer-links">
            ...
            <p><i class="fas fa-envelope me-2"></i> <?php echo $settings['contact_email'] ?? 'info@colegiodenaujan.edu.ph'; ?></p>
      ...
      <div class="footer-bottom text-center">
        <p class="mb-0">&copy; <span id="year"></span> <?php echo $settings['institution_name'] ?? 'Colegio De Naujan'; ?>. All Rights Reserved.</p>
      </div>
    </div>
  </footer>
